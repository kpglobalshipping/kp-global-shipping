export const crewChange = {
  ...
  filipinoOnSigners: [
  { document: "Passport", requirement: "Copy" },
  { document: "Seaman's Book", requirement: "Copy" },
  { document: "International Certificate of Vaccination (ICV)", requirement: "Copy" },
  ...
  { document: "Flight Itinerary / E-ticket", requirement: "Copy" },
],
